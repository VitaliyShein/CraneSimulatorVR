...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public partial class XRGrabInteractable : XRBaseInteractable
    {
        ...
        [Header("Custom - Parent Settings")]
        [SerializeField]
        bool m_KeepOriginalParent = false;

        /// <summary>
        /// Whether to keep the original parent of this object when grabbed.
        /// Useful for levers and controls that should stay attached to a moving platform.
        /// </summary>
        public bool keepOriginalParent
        {
            get => m_KeepOriginalParent;
            set => m_KeepOriginalParent = value;
        }
...
#pragma warning restore 618
        ...
        protected virtual void Grab()
        {
            ...
            // ТОЛЬКО ЕСЛИ НЕ НУЖНО СОХРАНЯТЬ РОДИТЕЛЯ
            if (!m_KeepOriginalParent)
            {
        ...
        {
            // Возвращаем родителя только если не включен keepOriginalParent
            if (!m_KeepOriginalParent)
            {
